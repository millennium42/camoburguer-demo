...
- "src_auth_login_failure": "LOGIN_FAILURE" | kind=code-symbol | source=apps/api/src/auth.js:L9 | neighbors=[auth.js]
- "src_auth_loginattempts": "loginAttempts" | kind=code-symbol | source=apps/api/src/auth.js:L18 | neighbors=[auth.js]
- "src_auth_revokedtokens": "revokedTokens" | kind=code-symbol | source=apps/api/src/auth.js:L10 | neighbors=[auth.js]
- "src_auth_role_permissions": "ROLE_PERMISSIONS" | kind=code-symbol | source=apps/api/src/auth.js:L12 | neighbors=[auth.js]
...
- "src_print_queue_bridge_success_statuses": "BRIDGE_SUCCESS_STATUSES" | kind=code-symbol | source=apps/api/src/print-queue.js:L3 | neighbors=[print-queue.js]
...
- "src_server_aborttransaction": "abortTransaction()" | kind=code-symbol | source=apps/api/src/server.js:L123 | neighbors=[server.js]
...
- "src_server_changestock": "changeStock()" | kind=code-symbol | source=apps/api/src/server.js:L495 | neighbors=[server.js]
- "src_server_clearsessioncookies": "clearSessionCookies()" | kind=code-symbol | source=apps/api/src/server.js:L143 | neighbors=[server.js]
- "src_server_db": "db" | kind=code-symbol | source=apps/api/src/server.js:L81 | neighbors=[server.js]
- "src_server_emitfinanceevent": "emitFinanceEvent()" | kind=code-symbol | source=apps/api/src/server.js:L957 | neighbors=[server.js]
- "src_server_emitorderevent": "emitOrderEvent()" | kind=code-symbol | source=apps/api/src/server.js:L953 | neighbors=[server.js]
- "src_server_getopenshift": "getOpenShift()" | kind=code-symbol | source=apps/api/src/server.js:L946 | neighbors=[server.js]
- "src_server_getorder": "getOrder()" | kind=code-symbol | source=apps/api/src/server.js:L326 | neighbors=[server.js]
- "src_server_getorderbyidempotencykey": "getOrderByIdempotencyKey()" | kind=code-symbol | source=apps/api/src/server.js:L337 | neighbors=[server.js]
- "src_server_getshift": "getShift()" | kind=code-symbol | source=apps/api/src/server.js:L631 | neighbors=[server.js]
- "src_server_gettab": "getTab()" | kind=code-symbol | source=apps/api/src/server.js:L403 | neighbors=[server.js]
- "src_server_gettabpayment": "getTabPayment()" | kind=code-symbol | source=apps/api/src/server.js:L449 | neighbors=[server.js]
- "src_server_gettabpaymentbyidempotencykey": "getTabPaymentByIdempotencyKey()" | kind=code-symbol | source=apps/api/src/server.js:L457 | neighbors=[server.js]
- "src_server_insertentries": "insertEntries()" | kind=code-symbol | source=apps/api/src/server.js:L595 | neighbors=[server.js]
- "src_server_insertorder": "insertOrder()" | kind=code-symbol | source=apps/api/src/server.js:L292 | neighbors=[server.js]

## Instructions

Write a single JSON object mapping each node id to a one-sentence description
to: C:\Users\milla\Documents\Projetos\Git\camoburguer-demo\.graphify\description-instructions\batch-011.json
