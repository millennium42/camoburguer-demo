...
- "src_auth": "auth.js" | kind=code-symbol | source=apps/api/src/auth.js:L1 | neighbors=[0ee5518 fix(auth): impedir escalada de …, e0f5e6f New Commit, allowedLogin(), authenticate(), changePassword(), createCsrfToken()] | lang=en
...
- "tests_integrations_test": "integrations.test.js" | kind=code-symbol | source=tests/integrations.test.js:L1 | neighbors=[075c321 Audita demo e endurece operacao, e0a6d46 fix(integrations): classificar …, e0f5e6f New Commit, eef1d5a fix(integrations): tornar event…, classifyCommandError(), applyIntegratedTransition()] | lang=en
...
- "src_idempotency": "idempotency.js" | kind=code-symbol | source=apps/api/src/idempotency.js:L1 | neighbors=[e0f5e6f New Commit, basisPoints(), cancellationFingerprintPayload(), canonicalAddon(), canonicalItem(), canonicalJson()] | lang=en
